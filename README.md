...
*Holdings dashboard — real-time positions across all entities and brokers*

![Realized P&L](screenshots/realizedgains.png)
*Realized P&L ledger — filterable by entity, broker, category, and month*

![Excel Export](screenshots/export.png)
*Daily Excel report — positions, P&L summary, and cash balances*
...
[Live Demo](https://web-production-573485.up.railway.app/demo) · [LinkedIn](https://linkedin.com/in/ez-chen) · [Email](mailto:bryan.chen@berkeley.edu)
